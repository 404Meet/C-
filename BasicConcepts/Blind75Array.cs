...
//             return CanBreak(0, s, new HashSet<string>(wordDict));
//     }
//         private static bool CanBreak(int index, string s, HashSet<string> wordSet) {
//         if (index == s.Length) return true;

//         for (int end = index + 1; end <= s.Length; end++) {
//             string sub = s.Substring(index, end - index);
//             if (wordSet.Contains(sub) && CanBreak(end, s, wordSet)) {
//                 return true;
//             }
//         }
...
//         // //2,6,4,7,9 target:11
//         // MaximumSubArray(arr);
//         bool wb = WordBreak("leetcode", ["leet","code"]);
//     }
// }